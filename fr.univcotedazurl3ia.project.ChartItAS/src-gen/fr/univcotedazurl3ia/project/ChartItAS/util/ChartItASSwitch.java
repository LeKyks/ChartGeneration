 ...
 * @generated
 */
public class ChartItASSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
		case ChartItASPackage.NAMED_ELEMENT: {
