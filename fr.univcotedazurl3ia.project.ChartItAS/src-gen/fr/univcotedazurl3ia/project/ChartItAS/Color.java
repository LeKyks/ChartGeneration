 ...
 * <!-- end-user-doc -->
 * @see fr.univcotedazurl3ia.project.ChartItAS.ChartItASPackage#getColor()
 * @model
 * @generated
 */
public enum Color implements Enumerator {
	 ...
	 * @ordered
	 */
	LIGHT_GREY(10, "LightGrey", "LightGrey"),
	/**
	...
	* <!-- end-user-doc -->
	 ...
	 * @ordered
	 */
	public static final int LIGHT_GREY_VALUE = 10;
	 ...
	 * @generated
	 */
	private static final Color[] VALUES_ARRAY = new Color[] { BLUE, RED, GREEN, ORANGE, YELLOW, PURPLE, BLACK, BROWN,
			PINK, DARK_GREY, LIGHT_GREY, WHITE, };
	...
	public static Color get(int value) {
		...
		case PINK_VALUE:
			return PINK;
		case DARK_GREY_VALUE:
			return DARK_GREY;
		case LIGHT_GREY_VALUE:
			return LIGHT_GREY;
		case WHITE_VALUE:
			return WHITE;
		}
